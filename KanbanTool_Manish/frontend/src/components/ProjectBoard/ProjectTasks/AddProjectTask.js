...
class AddProjectTask extends Component {
    ...
    render() {
        ...
        return (
            <div className="add-PBI"style={{ 
      backgroundImage: `url("https://img.freepik.com/free-photo/hand-painted-watercolor-background-with-sky-clouds-shape_24972-1095.jpg?size=626&ext=jpg")`,backgroundSize:"contain"
    }}>
                <div className="container">
                    <div className="row">
                        <div className="col-md-8 m-auto">
                            ...
                            <h4 className="display-4 text-center"style={{fontWeight: 'bold' }}>Add Project Task</h4>
                            <p className="lead text-center"style={{fontWeight: 'bold' }}>Project Name and Code</p>
